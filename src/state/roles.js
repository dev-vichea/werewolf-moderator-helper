...
export const ROLES_CATALOG = [
  ...
  { name: 'Witch', team: 'Town', image: 'images/witch.jpeg', desc: 'Has 1 heal potion (saves wolf victim) and 1 poison potion (kills any player). Wakes up every night after Werewolves and can use both potions on the same night.', defaultCount: 1 },
